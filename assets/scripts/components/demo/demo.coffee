...
module.exports = React.createFactory React.createClass
  ...
  markedDown: ->
    ...
    raw_html = raw_html.replace("<h1 ", "<div class='indigo darken-4 z-depth-5' style='width: 100%; margin-top: -35px;'><h1 class='center-align white-text' style='padding: 20px' ")
    raw_html = raw_html.replace("<hr>", "
    </div>
    <div class='row'>
      <div class='col s12'>
        <div class='container'>
          <div class='card-pannel white hoverable' >
            <div class='container'>
